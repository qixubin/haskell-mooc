...
oddFactorial i 
    | even i = oddFactorial (i -1)
    | i == 1 = 1
    | otherwise = i * oddFactorial (i -2)
...
smallestDivisor i = smallestDivisor' i 2

smallestDivisor' :: Integer -> Integer -> Integer
smallestDivisor' i smallest 
    | smallest == i = i
    | i `mod` smallest == 0 = smallest
    | otherwise = smallestDivisor' i (smallest + 1)
------------------------------------------------------------------------------
